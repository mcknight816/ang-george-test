...
export class SaasyService {
   ...
   */
    ...
    updateSubscription(tenantId:string,data: SaasySubscription){
  ...
  */
  ...
  public static emptyPlan(): Plan {
        return {name:'',monthly:null,yearly:null,description:'', planId:'',features:[],suggested:false,buttonTitle:'',payUrl:''};
  }
